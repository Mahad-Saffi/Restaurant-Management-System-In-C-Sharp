...
SELECT ItemID, Name, Price, CostOfPurchase, Picture FROM Items WHERE (ItemID = @ItemID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=DESKTOP-2S9LEDE;Initial Catalog=RMSDatabase;Integrated Security=True;" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT ItemID, Name, Price, CostOfPurchase, Picture FROM dbo.Items";
        ...
        public virtual int FillBy(RMSDatabaseDataSet.ItemsDataTable dataTable) {
